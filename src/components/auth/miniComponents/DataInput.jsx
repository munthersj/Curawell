...
export default function DataInputs(props) {
  ...
  return (
    <div>
      ...
      <div
        className={`w-full h-auto  flex p-3.5  justify-center items-center mt-3  bg-grayc rounded-md border border-gray-400  text-sm font-cairo text-gray-400 `}
      >
        <input
          ...
          } focus:text-black  focus:outline-0 focus:text-md focus:p-1 transition-all s `}
          type={
