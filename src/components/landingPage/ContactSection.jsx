...
export default function ContactSection({ isInView, aboutInfo }) {
  return (
    <div
      class={`flex flex-col  py-10   sm:flex-row px-5    sm:px-20 justify-around  sm:justify-around    w-full h-screen`}
    >
      {/* Left Side */}
      <div class="w-full sm:w-1/2 py-10 sm:pl-10">
        <h1 class="text-6xl font-bold text-black py-20 flex justify-center sm:justify-start">
          Contact Us
        </h1>
      ...
      <div class="w-1/2 sm:flex hidden  justify-center items-center">
        <div class="h-130  w-140 mt-20 rounded-2xl relative">
          ...
          ></img>
          <div
            class={`flex justify-center items-center absolute bg-curawell w-15 h-20 ${
