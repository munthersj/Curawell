...
export default function QuickSub() {
  return (
    <section className="relative flex flex-col md:flex-row w-full h-[70vh] md:h-[60vh] bg-grayc ">
      ...
      {/* Text + CTA */}
      <div className="relative z-10 flex flex-col justify-center gap-6 px-6 py-10 md:px-16 lg:px-24 
        ...
        <p className="text-base sm:text-lg lg:text-xl text-gray-700 max-w-prose">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tincidunt integer elit
          cum sed etiam nisl arcu.
        </p>
