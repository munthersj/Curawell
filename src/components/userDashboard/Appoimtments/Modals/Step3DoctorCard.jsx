...
export default function Step3DoctorCard({
  ...
  // جداد
  isHomeCare, // boolean
  gender, // 'male' | 'female' | ''  (أو أي تمثيل عندك)
  setGender, // setter للجيندر من الأب
}) {
  ...
  }, [dispatch, selectedKeyService, selectedService, toYMD, today, isHomeCare]);
  ...
  return (
    <>
      ...
      <h2 className="text-lg font-bold text-black mb-4">
        {isHomeCare ? "Select Patient Gender" : "Choose Doctor"}
      </h2>

      {/* ======== محتوى ديناميكي ======== */}
      {isHomeCare ? (
        // ---------- وضع HomeCare: اختيار الجيندر فقط ----------
        <div className="mb-8">
