...
export default function SpecializedSlider({
  ...
  return (
    <div className="flex flex-col w-full  mt-10 md:mt-80">
      <h1 className="text-3xl md:text-5xl font-bold font-cairo">
        Our Specialized Clinics
      </h1>
      <div className="flex items-center w-full justify-center md:justify-end gap-4 pr-10 ">
